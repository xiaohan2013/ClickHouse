...
SELECT value FROM system.zookeeper WHERE path = '/clickhouse/tables/test/alter/replicas/r1/parts/201401_0_0_0' AND name = 'columns' FORMAT TabSeparatedRaw;
...
SELECT value FROM system.zookeeper WHERE path = '/clickhouse/tables/test/alter/replicas/r1/parts/201402_0_0_0' AND name = 'columns' FORMAT TabSeparatedRaw;
